...
namespace DormMIS
{
    public partial class checkCharge : Form
    {
        public checkCharge()
        {
            InitializeComponent();
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            DateTime MDate = this.dateTimePicker1.Value;       //检查时间
            ...
            cmd.CommandText = string.Format(@"SELECT [dormID]
                                                          ...
                                                          ,[CPerson]
                                                          ,[CMoney]
                                                      FROM [DormMIS].[dbo].[Charge]
                                                    WHERE dormID='{0}'and MDate='{1}'", dormID, MDate);
            //进行返回页面
            ...
            //获取数据源中的表
            this.dataGridView1.DataSource = ds.Tables["Charge"];
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            //删除信息
            cmd.CommandText = string.Format(@"DELETE FROM [DormMIS].[dbo].[Charge]
                                                             WHERE dormID='{0}'and MDate='{1}'", dormID, MDate);
            //检查是否删除成功
            try
            {
