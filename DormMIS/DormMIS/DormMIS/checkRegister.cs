...
namespace DormMIS
{
    public partial class checkRegister : Form
    {
        ...
        private void Button4_Click(object sender, EventArgs e)
        {
            ...
            //查询信息
            cmd.CommandText = string.Format(@"SELECT [PCome]
                                                          ,[DateCome]
                                                          ,[PLook]
                                                          ,[dormID]
                                                          ,[DateLeave]
                                                          ,[Remark]
                                                      FROM [DormMIS].[dbo].[Register]
            ...
            //获取数据源中的表
            this.dataGridView1.DataSource = ds.Tables["Register"];
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            //删除信息
            cmd.CommandText = string.Format(@"DELETE FROM [DormMIS].[dbo].[Register]
                                                             WHERE dormID='{0}'", dormID);
            //检查是否删除成功
            try
            {
